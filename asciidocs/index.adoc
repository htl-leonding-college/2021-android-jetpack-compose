...
icon:file-text-o[link=https://raw.githubusercontent.com/htl-leonding-college/2021-android-jetpack-compose/main/asciidocs/{docname}.adoc]
icon:github-square[link=https://github.com/htl-leonding-college/2021-android-jetpack-compose]
icon:home[link=https://htl-leonding-college.github.io/2021-android-jetpack-compose/]
endif::backend-html5[]
